...
const variants = {
  blue: {
    ...
    dark: {
      ...
      blobHighlight: "#7DF9FF", // Electric Blue
      blobShadow: "rgba(0, 81, 255, 0.18)",
      innerGlow: "rgba(0, 0, 255, 0.07)",
      innerHighlight: "rgba(125, 249, 255, 0.1)",
      outerBg: "radial-gradient(circle 80px at 80% -10%, #333, #181b1b)",
      innerBg: "radial-gradient(circle 80px at 80% -50%, #555, #0f1111)",
      textColor: "#ffffff",
    },
  },
  pink: {
