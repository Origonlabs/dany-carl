export default function MusicSection() {
  return (
    <section className="w-full py-24 sm:py-32 lg:py-40 bg-secondary/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="rounded-xl overflow-hidden shadow-2xl transition-shadow duration-300 hover:shadow-primary/20">
            <iframe
